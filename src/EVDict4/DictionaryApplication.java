...
public class DictionaryApplication extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton11.setIcon(new javax.swing.ImageIcon("src\\EVDict4\\image\\guide_icon.jpg")); // NOI18N
    ...
    private void search_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_ButtonActionPerformed
        ...
        for(Word word_iterator : dic_Application.dict.words) {
            if(word_iterator.getWord_target().equals(word_Searching)) {
                ...
                defaultTableModel.addRow(new Object[]{word_Target, word_explain});
                finding_Word = true;
                break;
            }
        }
        if(!finding_Word) {
            defaultTableModel.addRow(new Object[]{"","Can't find the word in dictionary!"});
        }
